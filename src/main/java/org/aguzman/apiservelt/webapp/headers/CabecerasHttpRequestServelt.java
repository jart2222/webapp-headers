package org.aguzman.apiservelt.webapp.headers;
...
public class CabecerasHttpRequestServelt extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            out.println("       <ul>");
            out.println("           <li> metodo htttp: "+metodoHttp+ " </li>");
            out.println("           <li> request uri: "+requestUri+ " </li>");
            out.println("           <li> request url: "+requestUrl+ " </li>");
            out.println("           <li> context path: "+contexPath+ " </li>");
            out.println("           <li> servelt path: "+servletPath+ " </li>");
